...
/**
  ...
  *
  */
int32_t __weak lps22hh_write_reg(const stmdev_ctx_t *ctx, uint8_t reg, const uint8_t * bufp, uint16_t len)
{
  int32_t ret;
  ...
  ret = ctx->write_reg(ctx->handle, reg, bufp, len);
...
/**
  ...
  *
  */
int32_t lps22hh_pin_int_route_set(const stmdev_ctx_t *ctx, lps22hh_pin_int_route_t *val)
{
